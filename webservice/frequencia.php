...
if(!$con) {
  ...
  //SQL de BUSCA LISTAGEM
   $sql="select COUNT(frequencia.frequencia) as faltas,disciplina.carga_horaria, SUM(frequencia.aula_dada) as aulasdadas, aluno.nome as aluno, turma.turma, disciplina.nome as disciplina_nome,professor.nome as professor from frequencia 
...
inner join disciplina on disciplina.id_disc = atribuicao.id_disc_atr = '".$aluno."' and aluno.id_aluno = '".$materia."'"; 
