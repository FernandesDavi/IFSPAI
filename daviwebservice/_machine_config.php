...
GlobalConfig::$CONNECTION_SETTING->ConnectionString = "186.202.152.167:3306";
GlobalConfig::$CONNECTION_SETTING->DBName = "daviwebservice";
GlobalConfig::$CONNECTION_SETTING->Username = "daviwebservice";
GlobalConfig::$CONNECTION_SETTING->Password = "davi41947181";
...
/** the root url of the application with trailing slash, for example http://localhost/ifspai/ */
GlobalConfig::$ROOT_URL = RequestUtil::GetServerRootUrl() . 'daviwebservice/';
