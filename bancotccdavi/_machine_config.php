...
GlobalConfig::$CONNECTION_SETTING->ConnectionString = "179.188.16.99:3306";
GlobalConfig::$CONNECTION_SETTING->DBName = "bancotccdavi";
GlobalConfig::$CONNECTION_SETTING->Username = "bancotccdavi";
...
/** the root url of the application with trailing slash, for example http://localhost/bancotccdavi/ */
GlobalConfig::$ROOT_URL = RequestUtil::GetServerRootUrl() . 'bancotccdavi/';
