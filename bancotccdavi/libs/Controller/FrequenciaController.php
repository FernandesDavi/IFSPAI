...
class FrequenciaController extends AppBaseController
{
	...
	public function Query()
	{
		try
		{
			...
			if ($filter) $criteria->AddFilter(
				new CriteriaFilter('IdFreq,Dia,AulaDada,Frequencia,IdAlunoFreq,IdAtribuicaoFreq'
				, '%'.$filter.'%')
			);
	...
	public function Read()
	{
		try
		{
			$pk = $this->GetRouter()->GetUrlParam('idFreq');
	...
	public function Create()
	{
		try
		{
			...
			// $frequencia->IdFreq = $this->SafeGetVal($json, 'idFreq');
			...
			$frequencia->IdAlunoFreq = $this->SafeGetVal($json, 'idAlunoFreq');
			$frequencia->IdAtribuicaoFreq = $this->SafeGetVal($json, 'idAtribuicaoFreq');
	...
	public function Update()
	{
		try
		{
			...
			// $frequencia->IdFreq = $this->SafeGetVal($json, 'idFreq', $frequencia->IdFreq);
			...
			$frequencia->IdAlunoFreq = $this->SafeGetVal($json, 'idAlunoFreq', $frequencia->IdAlunoFreq);
			$frequencia->IdAtribuicaoFreq = $this->SafeGetVal($json, 'idAtribuicaoFreq', $frequencia->IdAtribuicaoFreq);
