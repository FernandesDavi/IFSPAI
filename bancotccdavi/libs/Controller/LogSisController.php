...
class LogSisController extends AppBaseController
{
	...
	public function Query()
	{
		try
		{
			...
			if ($filter) $criteria->AddFilter(
				new CriteriaFilter('IdLog,IoEs,UsuarioId,DataHora'
				, '%'.$filter.'%')
			);
	...
	public function Read()
	{
		try
		{
			$pk = $this->GetRouter()->GetUrlParam('idLog');
	...
	public function Create()
	{
		try
		{
			...
			// $logsis->IdLog = $this->SafeGetVal($json, 'idLog');
	...
	public function Update()
	{
		try
		{
			...
			// $logsis->IdLog = $this->SafeGetVal($json, 'idLog', $logsis->IdLog);
