...
class NotasController extends AppBaseController
{
	...
	public function Query()
	{
		try
		{
			...
			if ($filter) $criteria->AddFilter(
				new CriteriaFilter('IdNotas,AvaliacaoNome,Datas,Calculo,Nota,IdAlunoNotas,IdAtribuicaoNotas'
				, '%'.$filter.'%')
			);
	...
	public function Create()
	{
		try
		{
			...
			$notas->Datas = date('Y-m-d H:i:s',strtotime($this->SafeGetVal($json, 'datas')));
			$notas->Calculo = $this->SafeGetVal($json, 'calculo');
			$notas->Nota = $this->SafeGetVal($json, 'nota');
			$notas->IdAlunoNotas = $this->SafeGetVal($json, 'idAlunoNotas');
			$notas->IdAtribuicaoNotas = $this->SafeGetVal($json, 'idAtribuicaoNotas');
	...
	public function Update()
	{
		try
		{
			...
			$notas->Datas = date('Y-m-d H:i:s',strtotime($this->SafeGetVal($json, 'datas', $notas->Datas)));
			$notas->Calculo = $this->SafeGetVal($json, 'calculo', $notas->Calculo);
			$notas->Nota = $this->SafeGetVal($json, 'nota', $notas->Nota);
			$notas->IdAlunoNotas = $this->SafeGetVal($json, 'idAlunoNotas', $notas->IdAlunoNotas);
			$notas->IdAtribuicaoNotas = $this->SafeGetVal($json, 'idAtribuicaoNotas', $notas->IdAtribuicaoNotas);
