...
require_once("DAO/FrequenciaCriteriaDAO.php");

/**
 * The FrequenciaCriteria class extends FrequenciaDAOCriteria and is used
 ...
 * @version 1.0
 */
class FrequenciaCriteria extends FrequenciaCriteriaDAO
{
