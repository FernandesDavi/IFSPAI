...
require_once("DAO/DisciplinaCriteriaDAO.php");

/**
 * The DisciplinaCriteria class extends DisciplinaDAOCriteria and is used
 ...
 * @version 1.0
 */
class DisciplinaCriteria extends DisciplinaCriteriaDAO
{
