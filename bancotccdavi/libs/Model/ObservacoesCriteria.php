...
require_once("DAO/ObservacoesCriteriaDAO.php");

/**
 * The ObservacoesCriteria class extends ObservacoesDAOCriteria and is used
 ...
 * @version 1.0
 */
class ObservacoesCriteria extends ObservacoesCriteriaDAO
{
