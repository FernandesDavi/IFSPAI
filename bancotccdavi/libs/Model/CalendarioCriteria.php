...
require_once("DAO/CalendarioCriteriaDAO.php");

/**
 * The CalendarioCriteria class extends CalendarioDAOCriteria and is used
 ...
 * @version 1.0
 */
class CalendarioCriteria extends CalendarioCriteriaDAO
{
