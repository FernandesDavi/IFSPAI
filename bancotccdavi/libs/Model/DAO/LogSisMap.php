...
class LogSisMap implements IDaoMap, IDaoMap2
{
	...
	public static function GetFieldMaps()
	{
		...
		{
			self::$FM = Array();
			self::$FM["IdLog"] = new FieldMap("IdLog","log_sis","id_log",true,FM_TYPE_INT,11,null,true);
			...
			self::$FM["DataHora"] = new FieldMap("DataHora","log_sis","data_hora",false,FM_TYPE_DATETIME,null,null,false);
		}
		return self::$FM;
	}
