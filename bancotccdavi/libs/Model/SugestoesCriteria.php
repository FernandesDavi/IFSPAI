...
require_once("DAO/SugestoesCriteriaDAO.php");

/**
 * The SugestoesCriteria class extends SugestoesDAOCriteria and is used
 ...
 * @version 1.0
 */
class SugestoesCriteria extends SugestoesCriteriaDAO
{
